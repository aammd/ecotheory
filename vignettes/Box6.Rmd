...
## Online Box 6: R code to simulate a colonization-competition tradeoff model in 2 patches: Figure 4.10 in the book

`init.1` & `m` can be set to reproduce each panel in Figure 4.10
