...
## Online Box 2: R code for simulating dynamics with or without constant and frequency-dependent selection in local, two species communities: Figures 4.1, 4.2, 4.3 and 4.6 in the book.
...
4. Graphing the results is done much as in Box 4.1, but now using the `lines` function to add a separate line for each of the simulations.
